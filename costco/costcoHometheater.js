...
var fs = require('fs');
const start_url = "https://www.costco.com/home-theater-systems.html?sortBy=PriceMin%7C0";
let pagesVisited = {};
let promises = [];
let pagesUrls = [];
...
async function collectLinks($,url) {
  var links = $('div.categoryplist p.description a');
  var pagelinks = $('div.categoryplist div.paging li.page a');
     if (links) {
      links.each(function() {
...
fs.writeFile("costcoHomeTheater.json", jsonContent, 'utf8', function(err) {
   if (err) {
